...
| **ANTHROPIC_BASE_URL** | API 服务地址 | 使用 `https://api.augmentproxy.com`（与主站地址相同） |
...
export ANTHROPIC_BASE_URL=https://api.augmentproxy.com
...
$env:ANTHROPIC_BASE_URL = "https://api.augmentproxy"
$env:ANTHROPIC_AUTH_TOKEN = "sk-..."
$env:API_TIMEOUT_MS = "300000"  # 设置为 300 秒超时

# windows cmd 设置环境变量
set ANTHROPIC_BASE_URL=https://api.augmentproxy.com
