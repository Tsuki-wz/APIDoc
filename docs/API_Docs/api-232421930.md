  ...
  /v1/chat/completions:
    post:
      ...
      description: |
        ...
        官方文档：https://docs.anthropic.com/en/docs/build-with-claude/vision
      tags:
        - 聊天(Chat)/Anthropic Claude 接口/chat兼容格式
      parameters:
        - name: Content-Type
          in: header
          description: ''
      ...
      security:
        - bearer: []
      x-apifox-folder: 聊天(Chat)/Anthropic Claude 接口/chat兼容格式
      x-apifox-status: released
      x-run-in-apifox: https://app.apifox.com/web/project/5443236/apis/api-232421930-run
components:
  schemas: {}
  securitySchemes:
    bearer:
