...
paths:
  /replicate/v1/predictions:
    post:
      summary: 创建任务 lucataco/remove-bg
      deprecated: false
      description: 官方文档:https://replicate.com/lucataco/remove-bg
      tags:
        - Replicate 聚合平台
      parameters:
        - name: Authorization
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/5443236/apis/api-327032732-run
components:
  schemas: {}
  securitySchemes:
    bearer:
