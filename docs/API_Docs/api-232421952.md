  ...
  /v1/chat/completions:
    post:
      ...
      description: |-
        ...
        比如这个GPTs：https://chatgpt.com/g/g-B3hgivKK9-write-for-me

        那么它的模型名应该填写为：gpt-4-gizmo-g-B3hgivKK9


        GPTs列表：https://chatgpt.com/gpts
      tags:
        - GPTs 相关
      parameters:
        - name: Content-Type
      ...
      security:
        - bearer: []
      x-apifox-folder: GPTs 相关
      x-apifox-status: released
      x-run-in-apifox: https://app.apifox.com/web/project/5443236/apis/api-232421952-run
components:
  schemas: {}
  securitySchemes:
    bearer:
