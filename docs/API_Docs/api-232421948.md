  ...
  /v1/chat/completions:
    post:
      ...
      description: |-
        ...
        官方文档：https://ai.google.dev/gemini-api/docs/text-generation?hl=zh-cn
      tags:
        ...
        content:
          application/json:
            ...
            example:
              messages:
                - role: system
                  content: 你是一直小猪.你会在回复开始的时候 加一个'哼哼'
                - role: user
                  content: 你是谁?
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/5443236/apis/api-232421948-run
components:
  schemas: {}
  securitySchemes:
    bearer:
