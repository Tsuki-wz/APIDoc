  ...
  /v1/chat/completions:
    post:
      ...
      description: |-
        ...
        官方文档：https://platform.openai.com/docs/guides/tools?api-mode=responses
      tags:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/5443236/apis/api-232421920-run
components:
  schemas: {}
  securitySchemes:
    bearer:
