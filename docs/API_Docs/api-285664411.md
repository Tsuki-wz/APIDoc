  ...
  /v1/chat/completions:
    post:
      ...
      description: >-
        ...
        官方文档：https://platform.openai.com/docs/guides/reasoning?api-mode=responses
      tags:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/5443236/apis/api-285664411-run
components:
  schemas: {}
  securitySchemes:
    bearer:
