  ...
  /v1/messages:
    post:
      ...
      description: >
        ...
        官方文档：https://docs.anthropic.com/en/docs/agents-and-tools/tool-use/overview#how-tool-use-works
      tags:
      ...
      parameters:
        ...
        - name: anthropic-beta
          ...
          description: ''
          required: false
          example: structured-outputs-2025-11-13
          schema:
            type: string
      requestBody:
        content:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/5443236/apis/api-406138223-run
components:
  schemas: {}
  securitySchemes:
    bearer:
