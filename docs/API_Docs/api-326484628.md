...
paths:
  /replicate/v1/predictions:
    post:
      summary: 创建任务 sujaykhandekar/object-removal
      deprecated: false
      description: 官方文档:https://replicate.com/sujaykhandekar/object-removal
      tags:
        - Replicate 聚合平台
      parameters:
        - name: Authorization
              ...
              properties:
                ...
                input:
                  ...
                  properties:
                    image_path:
                      type: string
                      description: 输入图像（理想情况下是方形图像）
                    objects_to_remove:
                      type: string
                      description: >-
                        要移除的对象（用逗号分隔，例如汽车、猫、鸟）。完整名称列表请访问https://github.com/sujaykhandekar/Automated-objects-removal-inpainter/blob/master/segmentation_classes.txt。
                  required:
                    - image_path
                  x-apifox-orders:
                    - image_path
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/5443236/apis/api-326484628-run
components:
  schemas: {}
  securitySchemes:
    bearer:
